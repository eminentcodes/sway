...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="share-strip"><div><div className="eyebrow">Share the read</div><h2>Make a good call<br />a public flex.</h2></div><p>Share your streak, your record, and the round that made you right.</p><Link className="dark-btn nav-link-btn" href="/app">Launch app <span>↗</span></Link></section>
    ...
    <footer className="footer"><a className="brand" href="#top"><LogoMark /><span>sway</span></a><span>Built on Somnia · DreamDEX · Shannon testnet</span><div className="footer-links"><a href="https://testnet.somnia.network/" target="_blank" rel="noreferrer">Testnet faucet</a><a href="https://github.com/Somnia-Network" target="_blank" rel="noreferrer">DreamDEX contracts</a><Link href="/app">Launch app ↗</Link></div></footer>
